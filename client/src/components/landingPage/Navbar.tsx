...
export default function Navbar() {
  ...
  return (
   <nav className="z-[99] p-6 inset-x-0 top-0 flex justify-between items-center py-6 bg-transparent w-full">
      <h1 className="text-4xl font-semibold text-zinc-800 dark:text-gray-300 mr-5">Pantry</h1>
